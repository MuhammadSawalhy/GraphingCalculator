...
namespace MathPackage.Operations
{
    public sealed class Mod : Node
    {
        ...
        public Mod(Node children1, Node children2) : base(children1, children2){}
        public override double Calculate(CalculationSetting CalculationSetting, Dictionary<Loyc.Symbol, Node> tempVars){return Children[0].Calculate(CalculationSetting, tempVars) % Children[1].Calculate(CalculationSetting, tempVars);}
