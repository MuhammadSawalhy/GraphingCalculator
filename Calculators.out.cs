    ...
    abstract class CalculatorCore
    {
        ...
        public static CalculatorCore New(LNode expr, Dictionary<Symbol, LNode> vars, CalcRange xRange, CalcRange yRange)
        {
            ...
            if (!isEquation)
            {
                ...
                // this will detect if the expression contains y in any side.
                Eval(expr, lookup);
            }
        ...
        public static number Eval(LNode expr, Func<Symbol, number> lookup)
        {
            ...
            {
                {
                    ...
                    else if (expr.Calls(CodeSymbols.NullCoalesce, 2) && (a = expr.Args[0]) != null && (b = expr.Args[1]) != null)
                    {
                    ...
                    else if (expr.Calls((Symbol)"'xor", 2) && (a = expr.Args[0]) != null && (b = expr.Args[1]) != null)
                        return (Eval(a, lookup) != 0) != (Eval(b, lookup) != 0) ? (number)1 : (number)0;

                    else if (expr.Calls((Symbol)"xor", 2) && (a = expr.Args[0]) != null && (b = expr.Args[1]) != null)
                        return (number)((long)Eval(a, lookup) ^ (long)Eval(b, lookup));
                        ...
                        return G.IsInRange(Eval(a, lookup), Eval(lo, lookup), Eval(hi, lookup)) ? (number)1 : (number)0;
                    else if (expr.Calls((Symbol)"'in", 2) && (a = expr.Args[0]) != null && (tmp_10 = expr.Args[1]) != null && tmp_10.Calls((Symbol)"'[]", 2) && (lo = tmp_10.Args[0]) != null && (hi = tmp_10.Args[1]) != null)
                        return G.IsInRange(Eval(a, lookup), Eval(lo, lookup), Eval(hi, lookup)) ? (number)1 : (number)0;
                    else if (expr.Calls((Symbol)"'clamp", 2) && (a = expr.Args[0]) != null && (tmp_11 = expr.Args[1]) != null && tmp_11.Calls(CodeSymbols.Tuple, 2) && (lo = tmp_11.Args[0]) != null && (hi = tmp_11.Args[1]) != null || expr.Calls((Symbol)"clamp", 3) && (a = expr.Args[0]) != null && (lo = expr.Args[1]) != null && (hi = expr.Args[2]) != null)
                        return G.PutInRange(Eval(a, lookup), Eval(lo, lookup), Eval(hi, lookup));
            ...
            }
            {
                ...
                else if (expr.Calls((Symbol)"rnd", 1) && (a = expr.Args[0]) != null) return
                        (number)_r.Next((int)Eval(a, lookup));
