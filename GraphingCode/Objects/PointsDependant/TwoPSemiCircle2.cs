...
{
    public class TwoPSemiCircle2 : PointsDependant
    {
        public override PointDependantType Type { get; } = PointDependantType.TwoPSemiCircle2;
        public override string Get_Type => "SemiCircle2";
        public override int PointNumberAtLeast { get; } = 2;
        public override int PointNumberAtMost { get; } = 2;

        public TwoPSemiCircle2(GraphSetting GraphSetting_, Controls.GraphControl control = null) : base(GraphSetting_, control)
        {
        }
        public TwoPSemiCircle2(PointsDependant pd, GraphSetting GraphSetting_, Controls.GraphControl control = null) : base(pd, GraphSetting_, control)
        {
        }
